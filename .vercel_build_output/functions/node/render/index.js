...
var Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<nav class="${"navbar navbar-expand-lg navbar-light "}"><div class="${"container-fluid"}"><button class="${"navbar-toggler"}" type="${"button"}" data-bs-toggle="${"collapse"}" data-bs-target="${"#navbarToggler"}" aria-controls="${"navbarToggler"}" aria-expanded="${"false"}" aria-label="${"Toggle navigation"}"><span class="${"navbar-toggler-icon"}"></span></button>
    <a class="${"navbar-brand me-4"}" href="${"/"}"><img src="${""}" height="${"40"}" alt="${""}"></a>
    <div class="${"collapse navbar-collapse"}" id="${"navbarToggler"}"><ul class="${"navbar-nav me-auto mb-2 mb-lg-0"}"><li class="${"nav-item"}"><a class="${"nav-link active"}" aria-current="${"page"}" href="${"/"}">Inicio</a></li>
        <li class="${"nav-item"}"><a class="${"nav-link "}" aria-current="${"page"}" href="${"/training"}">Entrenamiento</a></li>
        <li class="${"nav-item"}"><a class="${"nav-link"}" href="${"/courses"}">Cursos</a></li></ul>
      <div class="${"d-flex"}"><a href="${"/crono"}" class="${"btn btn-outline-success me-2"}">Cronograma</a>

        <a href="${"#events"}" class="${"btn btn-outline-info"}">Evento</a></div></div></div>
</nav>`;
});
...
var Events = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const items = ["/img005.jpg", "/img002.jpg", "/img003.jpg", "/img004.jpg"];
  let activeIndex = 0;
  let $$settled;
  let $$rendered;
  do {
    $$settled = true;
    $$rendered = `<div id="${"events"}" class="${"justify-center align-center"}"><h1 class="${"mx-auto"}">eventos</h1>
  ${validate_component(Carousel, "Carousel").$$render($$result, {
    ...
    <div class="${"carousel-inner ratio ratio-16x9"}">${each(items, (item, index2) => `${validate_component(CarouselItem, "CarouselItem").$$render($$result, { itemIndex: index2, activeIndex }, {
        activeIndex: ($$value) => {
          activeIndex = $$value;
          $$settled = false;
        }
      }, {
        default: () => `<img${add_attribute("src", item, 0)} loading="${"lazy"}" class="${"d-block w-100"}"${add_attribute("alt", `${item} ${index2 + 1}`, 0)}>
        `
      })}`)}</div>
