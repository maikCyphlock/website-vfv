...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-93cc52e0.js",
      css: [assets + "/_app/assets/start-61d1577b.css", assets + "/_app/assets/vendor-cf063f61.css"],
      js: [assets + "/_app/start-93cc52e0.js", assets + "/_app/chunks/vendor-dc5e33e0.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.ico", "size": 1150, "type": "image/vnd.microsoft.icon" }, { "file": "favicon.png", "size": 5545, "type": "image/png" }, { "file": "img001.jpg", "size": 63028, "type": "image/jpeg" }, { "file": "img002.jpg", "size": 143296, "type": "image/jpeg" }, { "file": "img003.jpg", "size": 163479, "type": "image/jpeg" }, { "file": "img004.jpg", "size": 104253, "type": "image/jpeg" }, { "file": "img005.jpg", "size": 104793, "type": "image/jpeg" }, { "file": "img007.jpg", "size": 102890, "type": "image/jpeg" }, { "file": "markdown.css", "size": 30635, "type": "text/css" }, { "file": "navbar-logo.png", "size": 29548, "type": "image/png" }, { "file": "potrait.webp", "size": 179852, "type": "image/webp" }],
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/training\/?$/,
      params: empty,
      a: [".svelte-kit/build/components/layout.svelte", "src/routes/training.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/course\/?$/,
      params: empty,
      a: [".svelte-kit/build/components/layout.svelte", "src/routes/course.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/crono\/?$/,
      params: empty,
      a: [".svelte-kit/build/components/layout.svelte", "src/routes/crono.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/blog\/([^/]+?)\/?$/,
      params: (m) => ({ slug: d(m[1]) }),
      a: [".svelte-kit/build/components/layout.svelte", "src/routes/blog/[slug].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/training.svelte": () => Promise.resolve().then(function() {
    return training;
  }),
  "src/routes/course.svelte": () => Promise.resolve().then(function() {
    return course;
  }),
  "src/routes/crono.svelte": () => Promise.resolve().then(function() {
    return crono;
  }),
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-3fc1df9a.js", "css": ["assets/vendor-cf063f61.css"], "js": ["layout.svelte-3fc1df9a.js", "chunks/vendor-dc5e33e0.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-b3d42dfa.js", "css": ["assets/vendor-cf063f61.css"], "js": ["error.svelte-b3d42dfa.js", "chunks/vendor-dc5e33e0.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-4c2fd0c4.js", "css": ["assets/pages/index.svelte-292f3469.css", "assets/vendor-cf063f61.css"], "js": ["pages/index.svelte-4c2fd0c4.js", "chunks/vendor-dc5e33e0.js", "chunks/navbar-ed015ac1.js", "chunks/post-a54751e8.js"], "styles": [] }, "src/routes/training.svelte": { "entry": "pages/training.svelte-d522aff1.js", "css": ["assets/vendor-cf063f61.css"], "js": ["pages/training.svelte-d522aff1.js", "chunks/vendor-dc5e33e0.js", "chunks/navbar-ed015ac1.js"], "styles": [] }, "src/routes/course.svelte": { "entry": "pages/course.svelte-bf292cb4.js", "css": ["assets/vendor-cf063f61.css"], "js": ["pages/course.svelte-bf292cb4.js", "chunks/vendor-dc5e33e0.js", "chunks/navbar-ed015ac1.js"], "styles": [] }, "src/routes/crono.svelte": { "entry": "pages/crono.svelte-9a08fcca.js", "css": ["assets/pages/crono.svelte-296cfacf.css", "assets/vendor-cf063f61.css"], "js": ["pages/crono.svelte-9a08fcca.js", "chunks/vendor-dc5e33e0.js", "chunks/navbar-ed015ac1.js"], "styles": [] }, "src/routes/blog/[slug].svelte": { "entry": "pages/blog/[slug].svelte-b57eb9ed.js", "css": ["assets/vendor-cf063f61.css"], "js": ["pages/blog/[slug].svelte-b57eb9ed.js", "chunks/vendor-dc5e33e0.js", "chunks/navbar-ed015ac1.js", "chunks/post-a54751e8.js"], "styles": [] } };
...
var CarouselIndicators = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${spread([escape_object($$restProps), { class: escape_attribute_value(classes) }])}>${each(items, (item, index2) => `<button data-bs-target${add_attribute("aria-current", activeIndex === index2, 0)}${add_attribute("aria-label", item.title, 0)}${add_classes([activeIndex === index2 ? "active" : ""].join(" ").trim())}>${escape(item.title ? item.title : "")}
    </button>`)}</div>`;
});
...
var Navbar_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let isOpen = false;
  return `${validate_component(Navbar, "Navbar").$$render($$result, { light: true, expand: "md" }, {}, {
    default: () => `${validate_component(NavbarBrand, "NavbarBrand").$$render($$result, { href: "/" }, {}, {
      default: () => `<img src="${"/navbar-logo.png"}" width="${"36"}" alt="${""}">`
    })}
  ...
  ${validate_component(Collapse, "Collapse").$$render($$result, { isOpen, navbar: true, expand: "md" }, {}, {
      default: () => `${validate_component(Nav, "Nav").$$render($$result, { class: "me-auto", navbar: true }, {}, {
        default: () => `${validate_component(NavItem, "NavItem").$$render($$result, {}, {}, {
          default: () => `${validate_component(NavLink, "NavLink").$$render($$result, { href: "/" }, {}, { default: () => `Inicio` })}`
        })}
      ${validate_component(NavItem, "NavItem").$$render($$result, {}, {}, {
          default: () => `${validate_component(NavLink, "NavLink").$$render($$result, { href: "/training" }, {}, { default: () => `Entrenamiento` })}`
        })}
      ${validate_component(NavItem, "NavItem").$$render($$result, {}, {}, {
          default: () => `${validate_component(NavLink, "NavLink").$$render($$result, { href: "/course" }, {}, { default: () => `Curso` })}`
        })}`
      })}
    <div class="${"ms-auto"}">${validate_component(Button, "Button").$$render($$result, { color: "success", href: "/crono" }, {}, { default: () => `Cronograma` })}</div>`
    })}`
  })}`;
});
var Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"pt-5 my-5 text-center border-bottom"}"><h1 class="${"display-4 fw-bold"}">Comisi\xF3n de \xE1rbitros del estado portuguesa</h1>
  <div class="${"col-lg-6 mx-auto"}"><p class="${"lead mb-4"}">El arbitraje venezolano cada vez tiene mejor posicionamiento en los
      torneos internacionales. Esto, sumado a las buenas actuaciones que han
      tenido los colegiados en competiciones internacionales.
    </p></div>

  <div class="${"m-lg-4 p-lg-5"}"><img src="${"/potrait.webp"}" class="${"img-fluid border rounded-3 shadow-lg mb-2"}" alt="${"\xE1rbitros venezuela"}" loading="${"lazy"}"></div>
</div>`;
});
var css$2 = {
  code: ".carousel-inner.svelte-17jt9ds{transition:all ease-in-out .5s}",
  map: '{"version":3,"file":"events.svelte","sources":["events.svelte"],"sourcesContent":["<script>\\n  import {\\n    Col,\\n    Row,\\n    Carousel,\\n    CarouselItem,\\n    CarouselControl,\\n    CarouselIndicators,\\n  } from \\"sveltestrap\\";\\n  const items = [\\"/img005\\", \\"/img002\\", \\"/img003\\", \\"/img004\\",\\"img007\\"];\\n  let activeIndex = 0;\\n<\/script>\\n\\n<div id=\\"events\\" class=\\" justify-center align-center pb-5\\">\\n  <h1 class=\\"mx-auto\\">eventos</h1>\\n  <Carousel {items} bind:activeIndex class=\\"m-lg-5 slide shadow-lg\\">\\n    <CarouselIndicators bind:activeIndex {items} />\\n\\n    <div class=\\"carousel-inner ratio ratio-16x9\\">\\n      {#each items as item, index}\\n        <CarouselItem bind:activeIndex itemIndex={index}>\\n          <img\\n            src={item+\\".jpg\\"}\\n            loading=\\"lazy\\"\\n            class=\\"d-block w-100\\"\\n            alt={`${item} ${index + 1}`}\\n          />\\n        </CarouselItem>\\n      {/each}\\n    </div>\\n\\n    <CarouselControl direction=\\"prev\\" bind:activeIndex {items} />\\n    <CarouselControl direction=\\"next\\" bind:activeIndex {items} />\\n  </Carousel>\\n</div>\\n<style>\\n  .carousel-inner{\\n    transition: all ease-in-out .5s;\\n  }\\n</style>"],"names":[],"mappings":"AAoCE,8BAAe,CAAC,AACd,UAAU,CAAE,GAAG,CAAC,WAAW,CAAC,GAAG,AACjC,CAAC"}'
};
var Events = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<div id="${"events"}" class="${"justify-center align-center pb-5"}"><h1 class="${"mx-auto"}">eventos</h1>
  ${validate_component(Carousel, "Carousel").$$render($$result, {
      items,
      class: "m-lg-5 slide shadow-lg",
      activeIndex
    }, {
      activeIndex: ($$value) => {
        activeIndex = $$value;
      ...
      default: () => `${validate_component(CarouselIndicators, "CarouselIndicators").$$render($$result, { items, activeIndex }, {
        activeIndex: ($$value) => {
          activeIndex = $$value;
          $$settled = false;
        }
    ...
    <div class="${"carousel-inner ratio ratio-16x9 svelte-17jt9ds"}">${each(items, (item, index2) => `${validate_component(CarouselItem, "CarouselItem").$$render($$result, { itemIndex: index2, activeIndex }, {
        activeIndex: ($$value) => {
          activeIndex = $$value;
          $$settled = false;
        }
      }, {
        default: () => `<img${add_attribute("src", item + ".jpg", 0)} loading="${"lazy"}" class="${"d-block w-100"}"${add_attribute("alt", `${item} ${index2 + 1}`, 0)}>
        `
      })}`)}</div>
...
var Training = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Navbar_1, "Navbar").$$render($$result, {}, {}, {})}
${validate_component(Container, "Container").$$render($$result, { class: "mt-4" }, {}, {
    default: () => `<h3>V\xEDdeos para estudiar</h3>
  ${validate_component(Row, "Row").$$render($$result, { cols: { lg: 3, md: 2 } }, {}, {
      default: () => `${validate_component(Col, "Col").$$render($$result, { sm: "12", class: "mt-3" }, {}, {
        default: () => `<div class="${"ratio ratio-16x9"}"><iframe src="${"https://www.youtube.com/embed/jrnaTBj1WlY"}" title="${"YouTube video player"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen></iframe></div>`
      })}
    ${validate_component(Col, "Col").$$render($$result, { sm: "12", class: "mt-3" }, {}, {
        default: () => `<div class="${"ratio ratio-16x9"}"><iframe src="${"https://www.youtube.com/embed/jrnaTBj1WlY"}" title="${"YouTube video player"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen></iframe></div>`
      })}
    ${validate_component(Col, "Col").$$render($$result, { sm: "12", class: "mt-3" }, {}, {
        default: () => `<div class="${"ratio ratio-16x9"}"><iframe src="${"https://www.youtube.com/embed/jrnaTBj1WlY"}" title="${"YouTube video player"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen></iframe></div>`
...
var training = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Training
});
...
var css = {
  code: "iframe.svelte-80g2sa{width:100%;height:20rem}",
  map: '{"version":3,"file":"cronogram.svelte","sources":["cronogram.svelte"],"sourcesContent":["<script>\\n  import {\\n    Card,\\n    Column,\\n    Table,\\n    CardFooter,\\n    CardHeader,\\n    CardTitle,\\n    CardBody,\\n    CardSubtitle,\\n    CardText,\\n    Button,\\n    Spinner,\\n  } from \\"sveltestrap\\";\\n\\n  let spinner;\\n\\n  const IframeLoaded = () => {\\n    spinner.$destroy();\\n  };\\n<\/script>\\n\\n<section class=\\"mt-4\\">\\n  <h1 class=\\"text-center\\">tablas de arbitraje</h1>\\n  <div class=\\"d-flex justify-content-center align-center\\">\\n    <Spinner bind:this={spinner} />\\n  </div>\\n  <iframe\\n    on:reset={IframeLoaded}\\n    on:load={IframeLoaded}\\n    src=\\"https://docs.google.com/spreadsheets/d/e/2PACX-1vRyTSiW1NLIz2kPz8j2wI2sjifp59gj00u2509c4w3EuWQkYDok73ckwLygJCbjmYugBT3Z_FFvvxvb/pubhtml?gid=0&amp;single=false&amp;widget=true&amp;headers=true\\"\\n  />\\n</section>\\n\\n<style>\\n  iframe {\\n    width: 100%;\\n    height: 20rem;\\n  }\\n</style>\\n"],"names":[],"mappings":"AAmCE,MAAM,cAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,AACf,CAAC"}'
};
var Cronogram = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let spinner;
  $$result.css.add(css);
  let $$settled;
  let $$rendered;
  do {
    $$settled = true;
    $$rendered = `<section class="${"mt-4"}"><h1 class="${"text-center"}">tablas de arbitraje</h1>
  <div class="${"d-flex justify-content-center align-center"}">${validate_component(Spinner, "Spinner").$$render($$result, { this: spinner }, {
      this: ($$value) => {
        spinner = $$value;
        $$settled = false;
      }
    }, {})}</div>
  <iframe src="${"https://docs.google.com/spreadsheets/d/e/2PACX-1vRyTSiW1NLIz2kPz8j2wI2sjifp59gj00u2509c4w3EuWQkYDok73ckwLygJCbjmYugBT3Z_FFvvxvb/pubhtml?gid=0&single=false&widget=true&headers=true"}" class="${"svelte-80g2sa"}"></iframe>
</section>`;
  } while (!$$settled);
  return $$rendered;
});
var Crono = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>cronograma</title>`, ""}`, ""}

${validate_component(Navbar_1, "Navbar").$$render($$result, {}, {}, {})}
${validate_component(Cronogram, "Cronogram").$$render($$result, {}, {}, {})}`;
});
var crono = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Crono
});
